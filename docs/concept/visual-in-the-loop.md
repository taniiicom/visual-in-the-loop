...
> リポジトリの SKILL.md の配置はどちらにしますか?

- 主要な agent skills では，どのようなディレクトリ構成で，公開されていますか?
- 大規模から小規模まで，多く採用されている有名どころの skills を調査してください
- それと，多くの skills は，使いたいユーザが以下のように追加できるので，それも合わせて考えてくださいね
...
- デファクトスタンダードを必ず検索して深く調査してください

> Python の実行方法はどれにしますか?

- 上のような， skills の追加方法を考えると，任意のユーザ環境で整備されていることを前提としているのは， Python ではなく， node だと思ったのですがどうですか?
